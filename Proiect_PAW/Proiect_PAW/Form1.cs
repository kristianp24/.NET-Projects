...
namespace Proiect_PAW
{
    public partial class Form1 : Form
    {
        ...
        private void vizualizareCartiToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            //Ordonam datele dupa cate ori au fost aparute in Lista
        ...
        private void vizualizareBazaDeDateToolStripMenuItem_Click(object sender, EventArgs e)
        {
            AfisareDate afisareDB = new AfisareDate();
            afisareDB.Show();
        }
    }
}
